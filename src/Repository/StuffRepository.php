 ...
 */
class StuffRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(Stuff $entity, bool $flush = false): void
    {
    ...
    public function remove(Stuff $entity, bool $flush = false): void
    {
